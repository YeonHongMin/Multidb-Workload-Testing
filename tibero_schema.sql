-- ============================================================================
-- Tibero DDL - 부하 테스트용 스키마 (Oracle 호환 문법)
-- ============================================================================
-- 실행 방법: tbsql username/password@service_name @tibero_schema.sql
...
TABLESPACE USR_DATA    -- Tibero 기본 테이블스페이스 (환경에 맞게 수정)
ENABLE ROW MOVEMENT;
...
FROM USER_SEGMENTS
WHERE SEGMENT_NAME = 'LOAD_TEST'
AND SEGMENT_TYPE = 'TABLE PARTITION';

PROMPT
PROMPT ============================================================================
PROMPT Tibero schema creation completed successfully!
PROMPT ============================================================================
PROMPT
PROMPT Note: Tibero는 Oracle과 호환되는 DBMS입니다.
PROMPT - SEQUENCE, HASH PARTITION 등 Oracle 문법 지원
PROMPT - 일부 기능은 Tibero 버전에 따라 다를 수 있습니다
PROMPT - 자세한 내용은 Tibero 공식 문서를 참조하세요
PROMPT ============================================================================
PROMPT
